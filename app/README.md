...
Flyway runs automatically on startup and applies all migrations in `src/main/resources/db/migration/`.
...
JaCoCo coverage report is generated at `target/site/jacoco/index.html` after `mvn verify`.

...
- [ ] Rate limiting configurado no webhook (`slowapi`)
...
- [ ] Timeout configurado nas chamadas de API (evitar hang)
...
- [ ] Queries parametrizadas (ORM ou prepared statements — nunca string concatenation)
